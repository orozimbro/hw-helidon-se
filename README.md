...
```
java -jar target/hw-helidon-se.jar
```
...
```
docker build -t hw-helidon-se target
```

## Start the application with Docker

```
docker run --rm -p 8080:8080 hw-helidon-se:latest
```
...
kubectl get service hw-helidon-se  # Get service info
```
